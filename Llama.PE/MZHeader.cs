namespace Llama.PE
{
    ...
    public unsafe struct MZHeader
    {
        ...
        private const int MSDOSStubLength = 112;
        ...
        public static MZHeader CreateWithDefaultStub(uint newHeaderRVA, ushort initialStackPointer, ushort numberOfHeaderParagraphs, ushort numberOfRelocationEntries)
        {
            ...
            {
                14, 31, 186, 14, 0, 180, 9, 205, 33, 184, 1, 76, 205, 33, 84, 104, 105, 115, 32, 112, 114, 111, 103, 114, 97, 109, 32, 99, 97, 110, 110, 111, 116, 32, 98, 101, 32, 114, 117, 110, 32, 105, 110, 32, 68, 79, 83, 32, 109, 111, 100, 101, 46, 13, 13, 10, 36, 0, 0, 0, 0, 0, 0, 0, 80, 69, 0,
                0, 100, 134, 6, 0, 0, 0, 0, 0, 0, 244, 36, 1, 12, 111, 0, 0, 240, 0, 35, 2, 11, 2, 3, 0, 0, 102, 123, 0, 0, 246, 4, 0, 0, 0, 0, 0, 16, 245, 5, 0, 0, 16, 0, 0
            };
