...
{
    public class OpenParanthesisToken : TokenBase
    {
        public override void WriteSourceRecursive(ITextOutput textOutput, bool codeOnly = true) => WriteSource(textOutput, "(", !codeOnly);

        public static bool TryParse(ISourceReader reader, out OpenParanthesisToken result)
        {
            ...
            reader.Eat(1);
            result = new OpenParanthesisToken { PostNonCodeToken = NonCodeToken.ParseOrNull(reader) };
            return true;
        }
