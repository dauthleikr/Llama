namespace Llama.PE.Tests
{
    ...
    public class PEOptionalHeaderTests : TestsUsingHeaders
    {
        ...
        {
            Assert.That(OptionalHeader.Standard.ExecutableKind == ExecutableKind.ROM ||
                        OptionalHeader.Standard.ExecutableKind == ExecutableKind.PE32 ||
                        OptionalHeader.Standard.ExecutableKind == ExecutableKind.PE32Plus, "Bad executable kind (headers corrupt?)");
        }
    }
}